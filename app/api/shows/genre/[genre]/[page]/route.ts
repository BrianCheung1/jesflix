...
//returns popular show based on genre
...
export async function GET(
  ...
  if (session) {
    try {
      ...
      const options = {
        method: "GET",
        url: `https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&page=${page}&sort_by=popularity.desc&with_genres=${genre}`,
